    ...
    <div class="widget">
        ...
        <div class="widget-content">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php $data = DB::table('giangvien')->get();
                    $stt = 1 ?>
                    ...
                    <tr>
                        ...
                        <td class="td-actions">
                            <div class="btn-group">
                                ...
                                <a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
                                <ul class="dropdown-menu">
                                    <li><a href="#editModal" class="open-editModal" data-id="{{ $item->id}}" data-name="{{$u->name}}" data-username="{{$u->username}}"  data-nganh="{{$item->nganh_id}}" data-dienthoai="{{$item->dienthoai}}" data-email="{{$item->email}}" data-toggle="modal"><i class="fa fa-pencil"></i> Edit</a></li>
            ...
            <div id="editModal" class="modal-custom fade edit-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <form action="{{ route('admin.editteacher') }}" class="form-custom" method="post">
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                    <div class="modal-body">
            ...
            <div id="delModal" class="modal-custom fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <form action="{{route('admin.deleteteacher')}}" class="form-custom" method="post">
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                    <div class="modal-body">
                        <div class="row">
                            <div class="span4">
...
<script type="text/javascript">
    ...
    $('#safasajskhqh12').on('click', function() {
        ...
        $.ajax({
            ...
            url: "{{route('admin.recoverpassteacher')}}",
            statusCode: {
                200: function(data) {
                    $.toast({
                        heading: 'Thông tin',
    ...
    $(".container .mainnav li:eq(2)").addClass('active');
