        ...
        <div class="widget-content">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    $data = DB::table('thihocphan')->where('nganh_id', $sv->nganh_id)->where('hocky_id', $hk->id)->get();
                    $stt = 0;
                    ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <form style="margin: 0px" action="{{ route('student.register',$item->id) }}" method="POST">
                                <input type="hidden" name="_token" value="{{csrf_token()}}">
                                <input type="submit" class="btn btn-success" value="Đ.ký">
                            </form>
                        </td>
                    </tr>
                    @endforeach
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    $data = DB::table('phieudangky')
                        ...
                        ->where('sinhvien_id', $sv->id)->where('thihocphan.hocky_id', $hk->id)
