...
<script type="text/javascript" src="{{ URL::asset('/js/morph.js')}}"></script>
@endsection
@section('content')
<form>
    ...
    <div class="inputGroup inputGroup1">
        <label for="loginEmail" id="loginEmailLabel">Tên người dùng</label>
        <input type="email" id="loginEmail" name="username" maxlength="254" />
